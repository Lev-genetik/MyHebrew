...
# Load the Excel file
df = pd.read_excel('/media/Lev/F8C02E96C02E5B60/projects/2024/Lexicon_bot/Database.xlsx', header=0)

#get token
# Opens the file in read-only mode and assigns the contents to the variable cfg to be accessed further down
with open('/home/lev/PycharmProjects/tg_bot/git/config.json', 'r') as cfg:
